...
$nama = $_POST['name'];
$tmpt_Pemeriksaan = $_POST['location'];
$jenis_kelamin = $_POST['gender'];
$tgl_Periksa = $_POST['tanggalLahir'];
$berat_badan = $_POST['weight'];
$tinggi_badan = $_POST['height'];
$email = $_POST['email'];

$psn_baru = new BmiPasien(count($pasien) + 1, $tanggal, $nama, $tmpt_Pemeriksaan, $tgl_Periksa, $jenis_kelamin, $email, $berat_badan, $tinggi_badan);
...
<body>
    ...
    <footer class="footer py-2 bg-light border-top shadow-sm">
      <div class="footer m-2">
          <span class="black">-Salsabila Elsa Rahmadina_0110221153_2TI06</span>
      </div>
    </footer>
</body>
</html>