      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-md-12 col-12">
          <div class="header-image">
            <img src="<?php echo base_url('assets/kampus NF.jpg')?>" alt="#" />
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
              ...
              <div class="footer-widget f-about">
                <div class="logo">
                  <a href="index.html">
                  <img src="<?php echo base_url('assets/logo NF.png')?>" alt="#" class="img-fluid" width="200px" height="50px" />
                  </a>
                </div>
                <p>
                  Kuliah? STT-NF Aja
                ...
                <p class="copyright-text">
                  ...
                  <a href="https://www.instagram.com/shyahel_/?hl=id" rel="nofollow"> Salsabila Elsa Rahmadina </a>
                </p>
              </div>
              <!-- End Single Widget -->
            </div>
